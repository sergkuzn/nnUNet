...
def get_default_configuration_my(network, task, network_trainer, plans_identifier=default_plans_identifier,
                                 search_in=(nnunet.__path__[0], "training", "network_training"),
                                 base_module='nnunet.training.network_training',
                                 exp_name='test'):
    assert network in ['2d', '3d_lowres', '3d_fullres', '3d_cascade_fullres'], \
    ...
    output_folder_name = join(network_training_output_dir, exp_name)
