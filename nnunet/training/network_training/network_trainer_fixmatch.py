...
class NetworkTrainerFixmatch(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.dataset_tr = self.dataset_unlabeled = self.dataset_val = self.dataset_test = None  # do not need to be used, they just appear if you are using the suggested load_dataset_and_do_split
    ...
    def do_split(self):
        ...
        self.print_to_log_file("Unlabeled file file found.")

        unlabeled = load_pickle(unlabeled_file)
        keys = np.array(unlabeled)
